...
<section class="section-nav bg-neutral-100 dark:bg-neutral-800">
    ...
    <div class="nav-director-div select-none font-text border-radius no-drag">
        <button type="button" class="nav-director-span nav-director-span-left {before_click} border-radius font-blue" title="Before" data-href="{before_href}" onclick={()=>def.open_href(before_href)}>
        ...
        <button type="button" class="nav-director-span nav-director-span-right {next_click} border-radius font-blue" title="Next" data-href="{next_href}" onclick={()=>def.open_href(next_href)}>
    ...
    <!--  标题  -->
    <div class="nav-title-div center select-none font-title font-bold pywebview-drag-region can-drag" data-nav_value="{side_tab_data.tab_value}">{side_tab_data.tab_name}</div>
