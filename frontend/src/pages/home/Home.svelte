<script lang="ts">
    ...
    let ping_google: string = $state("...");
    let ping_bing: string = $state("...");
    let ping_youtube: string = $state("...");
    let ping_ithome: string = $state("...");
    let ping_host: string = $state("...");
    let ping_host2: string = $state("...");
    let test_db_data: string = $state("...");
    let ping_github: string = $state("...");
    ...
    const def = {
        ...
        ping_show: function(){
            ...
            that.ping_url("https://github.com").then(msg => {
                ping_github = msg;
            });
        ...
        <li class="li-group">
            ...
            <div class="li-group-content select-text">
                ...
                <p class="li-ping-p break">
                    ...
                    <span class="ping-res">{@html ping_host2}</span>
                </p>
            </div>
        </li>
        <li class="li-group">
