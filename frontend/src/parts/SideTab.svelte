...
<section class="section-side_tab select-none bg-neutral-200 dark:bg-neutral-800 border-radius">
    <ul class="side_tab-menu-ul scroll-y-style select-none font-text border-radius">
